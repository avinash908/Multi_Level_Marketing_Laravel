...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'check_user_is_registered' =>\App\Http\Middleware\CheckUserIsRegistered::class,
        'check_referral' =>\App\Http\Middleware\CheckReferral::class,
        'check_manager_earning' =>\App\Http\Middleware\CheckManagerEarning::class,
    ];
}
